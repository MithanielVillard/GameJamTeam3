...
public partial class EnchantmentDefeatist : IEnchantmentEffect
{
    ...
    private void DoEffect(StatsPlayer healthChange)
    {
        if (_healthTemp > (int)StatsPlayer.HEALTH)
            _player.SetPlayerStats(StatsPlayer.DEFENSE, GameJamTeam3.Scripts.Enums.StatsOperator.MINUS, GameJamTeam3.Scripts.Enums.StatsOperationUnit.INT, 1);
    }
}
